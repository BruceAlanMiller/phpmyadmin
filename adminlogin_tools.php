...
function validate( $link, $email = '', $pwd = '')
{
  ...
  else  { $e = mysqli_real_escape_string( $link, trim( $admin_email ) ) ; }
  ...
  if ( empty( $errors ) ) 
  {
    $q = "SELECT admin_id, admin_name, admin_lastname, admin_email FROM Administrators WHERE admin_email='$e' AND pass=SHA1('$p')" ;  
